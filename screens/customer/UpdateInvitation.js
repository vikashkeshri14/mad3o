           ...
           <View
            ...
            >
              <View className="mt-[25px]">
                ...
                <View className="flex">
                  {requireToAccept==0?(<Image className="w-[24px] self-center h-[24px]" source={require("../../assets/icons/unchecked.png")}/>):(<Image className="w-[24px] self-center h-[24px]" source={require("../../assets/icons/tick.png")}/>)}
                  
                </View>
                <View  className="flex pl-[10px]"><Text style={GlobalStyles.cairoSemiBold} className="text-[14px] text-[#747474]" >{i18n.t("require-to-accept")}</Text></View>
                </TouchableOpacity>
                </View>
                <View className="mt-[5px] pl-[10px] pr-[10px] mr-[20px]  flex flex-row ml-[20px]">
                <TouchableOpacity className="flex flex-row" onPress={()=>{
                ...
                <View className="flex">
                {phoneNotAllowed==0?(<Image className="w-[24px] self-center h-[24px]" source={require("../../assets/icons/unchecked.png")}/>):(<Image className="w-[24px] self-center h-[24px]" source={require("../../assets/icons/tick.png")}/>)}
                  
                  </View>
                <View  className="flex pl-[10px]"><Text style={GlobalStyles.cairoSemiBold} className="text-[14px] text-[#747474]" >{i18n.t("mobile-phone-not-allowed")}</Text></View>
                </TouchableOpacity>
                </View>
                <View className="mt-[5px] pl-[10px] pr-[10px] mr-[20px]  flex flex-row ml-[20px]">
                <TouchableOpacity className="flex flex-row" onPress={()=>{
                ...
                <View className="flex">
                {childrenNotAllowed==0?(<Image className="w-[24px] self-center h-[24px]" source={require("../../assets/icons/unchecked.png")}/>):(<Image className="w-[24px] self-center h-[24px]" source={require("../../assets/icons/tick.png")}/>)}
                  </View>
                <View  className="flex pl-[10px]"><Text style={GlobalStyles.cairoSemiBold} className="text-[14px] text-[#747474]" >{i18n.t("children-not-allowed")}</Text></View>
                </TouchableOpacity>
                </View>
              </View>
              <View className="mt-[25px]">
                ...
                <View
                  ...
                  className=
                       "mt-[5px]  h-[120px] rounded-[10px] pl-[10px] pr-[10px] mr-[20px] border-[#E4E4E4] border-[1px] ml-[20px]"
              ...
              <View className="mt-[25px]">
                ...
                <View className="mt-[5px] pl-[10px] pr-[10px] mr-[20px]  flex flex-row ml-[20px]">
                <View className="flex"><Image className="w-[24px] self-center h-[24px]" source={require("../../assets/icons/unchecked.png")}/></View>
                <View  className="flex pl-[10px]"><Text style={GlobalStyles.cairoSemiBold} className="text-[14px] text-[#747474]" >{i18n.t("send-welcome-message-when-the-event-start")}</Text></View>
                </View>
              </View>
              <View className="mt-[25px]">
                <View className="flex ml-[20px] mr-[20x]">
              ...
              <View className="mt-[25px]">
                ...
                <View className="mt-[5px] pl-[10px] pr-[10px] mr-[20px]  flex flex-row ml-[20px]">
                <View className="flex"><Image className="w-[24px] self-center h-[24px]" source={require("../../assets/icons/unchecked.png")}/></View>
                <View  className="flex pl-[10px]"><Text style={GlobalStyles.cairoSemiBold} className="text-[14px] text-[#747474]" >{i18n.t("send-farewell-message-when-event-end")}</Text></View>
                </View>
              </View>
              <View className="mt-[25px]">
                <View className="flex ml-[20px] mr-[20x]">
