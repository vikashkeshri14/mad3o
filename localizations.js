const en = {
  ...
  attachment: "مرفق",
  "invitation-added": "الدعوات المضافة",
  "edit-event": "إدارة بيانات الحفلة",
  "manage-guest-option": "إدارة خيارات المدعوين",
  "guest-list-management": "إدارة قائمة المدعوين",
  "manage-power-of-organizer": "إدارة صلاحيات المنظمين",
  all: "الكل",
  "attendance-list": "قائمة الحضور",
  "list-of-applogy": "قائمة المعتذرين",
  "no-answer": "لا يوجد رد",
  "not-sent": "غير مرسل",
  "update-event": "معلومات الحدث",
  "name-of-the-occasion": "إسم المناسبة",
  hostname: "اسم المضيف",
